...
**Wachttijd-indicatie en handelingsopties bij de korte-OI-blokkade genormeerd (presentatienorm).** Governancebesluit van de beheerder: een implementatie MAG bij een blokkade met reden `EMPTY_TABLE_CELL` informatief het eerstvolgende geldige tijdstip tonen, exact afgelezen uit het tabeldomein van tabel 4a (de eerstvolgende gevulde kolom voor de geldende herhalingsgroep), en MAG de bestaande vervolgroutes (wachten, meterregelplanning, niet duiken, handmatige beoordeling) als handelingsopties presenteren. De presentatie wijzigt de berekeningsstatus niet; statusmodel, codes, schema en toetsvectoren zijn ongewijzigd. Twee bronvoorbeelden pinnen de tabelgrenzen. Zie `rekencontract/README.md`, sectie 10, en `STANDAARD.md`, sectie 5.9.
